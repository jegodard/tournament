package fr.cspvolley.tournament.repository;

import fr.cspvolley.tournament.TournamentApp;
import fr.cspvolley.tournament.config.Constants;
import fr.cspvolley.tournament.config.audit.AuditEventConverter;
import fr.cspvolley.tournament.domain.PersistentAuditEvent;
...
import static fr.cspvolley.tournament.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
